...
function Flatpickr(e, t) {
    ...
    function a(e) {
        ...
        pe(e),
        he.selectedDates.length && (!he.minDateHasTime || "input" !== e.type || e.target.value.length >= 2 ? (i(),
    ...
    function i() {
        if (he.config.enableTime) {
            ...
            void 0 !== he.amPM && (e = e % 12 + 12 * ("PM" === he.amPM.textContent)),
            he.minDateHasTime && 0 === ge(he.latestSelectedDateObj, he.config.minDate) && (e = Math.max(e, he.config.minDate.getHours())) === he.config.minDate.getHours() && (t = Math.max(t, he.config.minDate.getMinutes())),
    ...
    function o(e, t, n) {
        ...
        he.minuteElement.value = he.pad(t),
        he.config.time_24hr || (he.amPM.textContent = e >= 12 ? "PM" : "AM"),
        !0 === he.config.enableSeconds && (he.secondElement.value = he.pad(n)))
    }
    function l(e) {
        var t = e.target.value;
        e.delta && (t = (parseInt(t) + e.delta).toString()),
        4 !== t.length && "Enter" !== e.key || (he.currentYearElement.blur(),
        /[^\d]/.test(t) || O(t))
    }
    function c(e, t, n) {
    ...
    function d() {
        if (he._handlers = [],
        he._animationLoop = [],
        he.config.wrap && ["open", "close", "toggle", "clear"].forEach(function(e) {
        ...
        he.isMobile)
            return X();
        if (he.debouncedResize = me(j, 50),
        he.triggerChange = function() {
            te("Change")
        }
        ,
        he.debouncedChange = me(he.triggerChange, 300),
        "range" === he.config.mode && he.daysContainer && c(he.daysContainer, "mouseover", function(e) {
            return P(e.target)
        }),
        c(window.document.body, "keydown", L),
        he.config.static || c(he._input, "keydown", L),
        ...
        c(he._input, "blur", I),
        !0 === he.config.clickOpens && c(he._input, "focus", he.open),
        he.config.noCalendar || (he.monthNav.addEventListener("wheel", function(e) {
            return e.preventDefault()
        }),
        c(he.monthNav, "wheel", me(ce, 10)),
        c(he.monthNav, "mousedown", s(se)),
        c(he.monthNav, ["keyup", "increment"], l),
        c(he.daysContainer, "mousedown", s(U)),
        he.config.animate && (c(he.daysContainer, ["webkitAnimationEnd", "animationend"], f),
        c(he.monthNav, ["webkitAnimationEnd", "animationend"], m))),
        he.config.enableTime) {
            var e = function(e) {
                return e.target.select()
            };
            c(he.timeContainer, ["wheel", "input", "increment"], a),
            c(he.timeContainer, "mousedown", s(p)),
            c(he.timeContainer, ["wheel", "increment"], he.debouncedChange),
            c(he.timeContainer, "input", he.triggerChange),
            c([he.hourElement, he.minuteElement], "focus", e),
            void 0 !== he.secondElement && c(he.secondElement, "focus", function() {
    ...
    function u() {
        for (var e = he._animationLoop.length; e--; )
            he._animationLoop[e](),
            he._animationLoop.splice(e, 1)
    }
    function f(e) {
        if (he.daysContainer.childNodes.length > 1)
            switch (e.animationName) {
            case "fpSlideLeft":
                he.daysContainer.lastChild.classList.remove("slideLeftNew"),
                he.daysContainer.removeChild(he.daysContainer.firstChild),
                he.days = he.daysContainer.firstChild,
                u();
                break;
            case "fpSlideRight":
                he.daysContainer.firstChild.classList.remove("slideRightNew"),
                he.daysContainer.removeChild(he.daysContainer.lastChild),
                he.days = he.daysContainer.firstChild,
                u()
            }
    }
    function m(e) {
        ...
        case "fpSlideRightNew":
            he.navigationCurrentMonth.classList.remove("slideLeftNew"),
            he.navigationCurrentMonth.classList.remove("slideRightNew");
    ...
    function g(e) {
        ...
        try {
            he.currentYear = e.getFullYear(),
            he.currentMonth = e.getMonth()
        } catch (t) {
    ...
    function v() {
        ...
        he.calendarContainer = de("div", "flatpickr-calendar"),
        he.calendarContainer.tabIndex = -1,
        he.config.noCalendar || (e.appendChild(k()),
        he.innerContainer = de("div", "flatpickr-innerContainer"),
        he.config.weekNumbers && he.innerContainer.appendChild(N()),
        he.rContainer = de("div", "flatpickr-rContainer"),
        he.rContainer.appendChild(E()),
        he.daysContainer || (he.daysContainer = de("div", "flatpickr-days"),
        he.daysContainer.tabIndex = -1),
        M(),
        he.rContainer.appendChild(he.daysContainer),
        he.innerContainer.appendChild(he.rContainer),
        e.appendChild(he.innerContainer)),
        he.config.enableTime && e.appendChild(x()),
        fe(he.calendarContainer, "rangeMode", "range" === he.config.mode),
        fe(he.calendarContainer, "animate", he.config.animate),
        he.calendarContainer.appendChild(e);
        ...
        if (he.config.inline || he.config.static) {
            ...
            he.config.inline && !t)
                return he.element.parentNode.insertBefore(he.calendarContainer, he._input.nextSibling);
            if (he.config.static) {
                var n = de("div", "flatpickr-wrapper");
                return he.element.parentNode.insertBefore(n, he.element),
                n.appendChild(he.element),
                he.altInput && n.appendChild(he.altInput),
                void n.appendChild(he.calendarContainer)
            }
        }
    ...
    function C(e, t, n, a) {
        ...
        return r.dateObj = t,
        r.$i = a,
        r.setAttribute("aria-label", he.formatDate(t, he.config.ariaDateFormat)),
        0 === ge(t, he.now) && (he.todayDateElem = r,
        r.classList.add("today")),
        i ? (r.tabIndex = -1,
        ae(t) && (r.classList.add("selected"),
        he.selectedDateElem = r,
        "range" === he.config.mode && (fe(r, "startRange", 0 === ge(t, he.selectedDates[0])),
        ...
        "range" === he.config.mode && (ie(t) && !ae(t) && r.classList.add("inRange"),
        1 === he.selectedDates.length && (t < he.minRangeDate || t > he.maxRangeDate) && r.classList.add("notAllowed")),
    ...
    function w(e, t) {
        var n = e + t || 0
          ...
          , i = function() {
            (a = a || he.days.childNodes[n]).focus(),
            "range" === he.config.mode && P(a)
        };
        if (void 0 === a && 0 !== t)
            return t > 0 ? (he.changeMonth(1),
            n %= 42) : t < 0 && (he.changeMonth(-1),
            n += 42),
            b(i);
        i()
    }
    function b(e) {
        if (!0 === he.config.animate)
            return he._animationLoop.push(e);
        e()
    }
    function M(e) {
        var t = (new Date(he.currentYear,he.currentMonth,1).getDay() - he.l10n.firstDayOfWeek + 7) % 7
          , n = "range" === he.config.mode;
        he.prevMonthDays = he.utils.getDaysinMonth((he.currentMonth - 1 + 12) % 12),
        he.selectedDateElem = void 0,
        ...
        n && (he.minRangeDate = new Date(he.currentYear,he.currentMonth - 1,r),
        he.maxRangeDate = new Date(he.currentYear,he.currentMonth + 1,(42 - t) % a)); r <= he.prevMonthDays; r++,
        o++)
        ...
        if (c.appendChild(i),
        he.config.animate && void 0 !== e)
            for (; he.daysContainer.childNodes.length > 1; )
                he.daysContainer.removeChild(he.daysContainer.firstChild);
        else
            y(he.daysContainer);
    ...
    function k() {
        var e = window.document.createDocumentFragment();
        he.monthNav = de("div", "flatpickr-month"),
        he.prevMonthNav = de("span", "flatpickr-prev-month"),
        he.prevMonthNav.innerHTML = he.config.prevArrow,
        he.currentMonthElement = de("span", "cur-month"),
        he.currentMonthElement.title = he.l10n.scrollTitle;
        var t = D("cur-year");
        return he.currentYearElement = t.childNodes[0],
        he.currentYearElement.title = he.l10n.scrollTitle,
        ...
        he.nextMonthNav = de("span", "flatpickr-next-month"),
        he.nextMonthNav.innerHTML = he.config.nextArrow,
        he.navigationCurrentMonth = de("span", "flatpickr-current-month"),
        he.navigationCurrentMonth.appendChild(he.currentMonthElement),
        he.navigationCurrentMonth.appendChild(t),
        e.appendChild(he.prevMonthNav),
        e.appendChild(he.navigationCurrentMonth),
        e.appendChild(he.nextMonthNav),
        he.monthNav.appendChild(e),
        Object.defineProperty(he, "_hidePrevMonthArrow", {
            get: function() {
    ...
    function x() {
        he.calendarContainer.classList.add("hasTime"),
        he.config.noCalendar && he.calendarContainer.classList.add("noCalendar"),
        he.timeContainer = de("div", "flatpickr-time"),
        he.timeContainer.tabIndex = -1;
        var e = de("span", "flatpickr-time-separator", ":")
          , t = D("flatpickr-hour");
        he.hourElement = t.childNodes[0];
        var n = D("flatpickr-minute");
        if (he.minuteElement = n.childNodes[0],
        he.hourElement.tabIndex = he.minuteElement.tabIndex = -1,
        ...
        he.hourElement.step = he.config.hourIncrement,
        he.minuteElement.step = he.config.minuteIncrement,
        he.hourElement.min = he.config.time_24hr ? 0 : 1,
        he.hourElement.max = he.config.time_24hr ? 23 : 12,
        he.minuteElement.min = 0,
        he.minuteElement.max = 59,
        he.hourElement.title = he.minuteElement.title = he.l10n.scrollTitle,
        he.timeContainer.appendChild(t),
        he.timeContainer.appendChild(e),
        he.timeContainer.appendChild(n),
        he.config.time_24hr && he.timeContainer.classList.add("time24hr"),
        he.config.enableSeconds) {
            he.timeContainer.classList.add("hasSeconds");
            var a = D("flatpickr-second");
            he.secondElement = a.childNodes[0],
            he.secondElement.value = he.latestSelectedDateObj ? he.pad(he.latestSelectedDateObj.getSeconds()) : "00",
            he.secondElement.step = he.minuteElement.step,
            he.secondElement.min = he.minuteElement.min,
            he.secondElement.max = he.minuteElement.max,
            he.timeContainer.appendChild(de("span", "flatpickr-time-separator", ":")),
            he.timeContainer.appendChild(a)
        }
        return he.config.time_24hr || (he.amPM = de("span", "flatpickr-am-pm", ["AM", "PM"][he.hourElement.value > 11 | 0]),
        he.amPM.title = he.l10n.toggleTitle,
        he.amPM.tabIndex = -1,
        he.timeContainer.appendChild(he.amPM)),
        he.timeContainer
    }
    function E() {
    ...
    function N() {
        return he.calendarContainer.classList.add("hasWeeks"),
        he.weekWrapper = de("div", "flatpickr-weekwrapper"),
        he.weekWrapper.appendChild(de("span", "flatpickr-weekday", he.l10n.weekAbbreviation)),
        he.weekNumbers = de("div", "flatpickr-weeks"),
        he.weekWrapper.appendChild(he.weekNumbers),
        he.weekWrapper
    }
    function T(e, t, n) {
        ...
        if (!(a < 0 && he._hidePrevMonthArrow || a > 0 && he._hideNextMonthArrow)) {
            if (he.currentMonth += a,
            (he.currentMonth < 0 || he.currentMonth > 11) && (he.currentYear += he.currentMonth > 11 ? 1 : -1,
            he.currentMonth = (he.currentMonth + 12) % 12,
            te("YearChange")),
            M(i ? void 0 : a),
            i)
                return te("MonthChange"),
                re();
            ...
            if (he.oldCurMonth = he.navigationCurrentMonth,
            he.navigationCurrentMonth = he.monthNav.insertBefore(he.oldCurMonth.cloneNode(!0), a > 0 ? he.oldCurMonth.nextSibling : he.oldCurMonth),
            a > 0 ? (he.daysContainer.firstChild.classList.add("slideLeft"),
            he.daysContainer.lastChild.classList.add("slideLeftNew"),
            he.oldCurMonth.classList.add("slideLeft"),
            he.navigationCurrentMonth.classList.add("slideLeftNew")) : a < 0 && (he.daysContainer.firstChild.classList.add("slideRightNew"),
            he.daysContainer.lastChild.classList.add("slideRight"),
            he.oldCurMonth.classList.add("slideRight"),
            he.navigationCurrentMonth.classList.add("slideRightNew")),
            he.currentMonthElement = he.navigationCurrentMonth.firstChild,
            he.currentYearElement = he.navigationCurrentMonth.lastChild.childNodes[0],
            re(),
    ...
    function _(e) {
        he.input.value = "",
        he.altInput && (he.altInput.value = ""),
        he.mobileInput && (he.mobileInput.value = ""),
        he.selectedDates = [],
        he.latestSelectedDateObj = void 0,
        he.showTimeInput = !1,
        he.redraw(),
        !1 !== e && te("Change")
    }
    function S() {
        he.isOpen = !1,
        he.isMobile || (he.calendarContainer.classList.remove("open"),
        he._input.classList.remove("active")),
        te("Close")
    }
    function Y() {
        ...
        he._handlers = [],
        he.mobileInput ? (he.mobileInput.parentNode && he.mobileInput.parentNode.removeChild(he.mobileInput),
        ...
        he.altInput && (he.input.type = "text",
        he.altInput.parentNode && he.altInput.parentNode.removeChild(he.altInput),
        delete he.altInput),
        he.input && (he.input.type = he.input._type,
        he.input.classList.remove("flatpickr-input"),
        he.input.removeAttribute("readonly"),
        he.input.value = ""),
    ...
    function I(e) {
        if (he.isOpen && !he.config.inline) {
            ...
            ("blur" === e.type ? n && e.relatedTarget && !F(e.relatedTarget) : !n && !t) && (e.preventDefault(),
            he.close(),
            "range" === he.config.mode && 1 === he.selectedDates.length && (he.clear(!1),
            he.redraw()))
        }
    }
    function O(e) {
        if (!(!e || he.currentYearElement.min && e < he.currentYearElement.min || he.currentYearElement.max && e > he.currentYearElement.max)) {
            var t = parseInt(e, 10)
              , n = he.currentYear !== t;
            he.currentYear = t || he.currentYear,
            he.config.maxDate && he.currentYear === he.config.maxDate.getFullYear() ? he.currentMonth = Math.min(he.config.maxDate.getMonth(), he.currentMonth) : he.config.minDate && he.currentYear === he.config.minDate.getFullYear() && (he.currentMonth = Math.max(he.config.minDate.getMonth(), he.currentMonth)),
            n && (he.redraw(),
            te("YearChange"))
        }
    }
    function A(e, t) {
        if (he.config.minDate && ge(e, he.config.minDate, void 0 !== t ? t : !he.minDateHasTime) < 0 || he.config.maxDate && ge(e, he.config.maxDate, void 0 !== t ? t : !he.maxDateHasTime) > 0)
            return !1;
        if (!he.config.enable.length && !he.config.disable.length)
            return !0;
        for (var n, a = he.parseDate(e, null, !0), i = he.config.enable.length > 0, r = i ? he.config.enable : he.config.disable, o = 0; o < r.length; o++) {
            ...
            if (n instanceof Date && n.getTime() === a.getTime())
                return i;
            if ("string" == typeof n && he.parseDate(n, null, !0).getTime() === a.getTime())
                return i;
    ...
    function L(e) {
        ...
        if ("Enter" === e.key && r && t)
            return he.setDate(he._input.value, !0, e.target === he.altInput ? he.config.altFormat : he.config.dateFormat),
            e.target.blur();
        if (n || o || l) {
            ...
            case "ArrowRight":
                if (!c)
                    ...
                    he.daysContainer) {
                        ...
                        he.config.enableTime && !c && he.hourElement.focus();
                break;
            case "ArrowUp":
            case "ArrowDown":
                e.preventDefault();
                var d = "ArrowDown" === e.key ? 1 : -1;
                he.daysContainer ? e.ctrlKey ? (O(he.currentYear - d),
                w(e.target.$i, 0)) : c || w(e.target.$i, 7 * d) : he.config.enableTime && (c || he.hourElement.focus(),
                a(e));
                break;
            case "Tab":
                e.target === he.hourElement ? (e.preventDefault(),
                he.minuteElement.select()) : e.target === he.minuteElement && (he.secondElement || he.amPM) ? (e.preventDefault(),
                (he.secondElement || he.amPM).focus()) : e.target === he.secondElement && (e.preventDefault(),
                he.amPM.focus());
                break;
            case "a":
                e.target === he.amPM && (he.amPM.textContent = "AM",
                i(),
                oe());
                break;
            case "p":
                e.target === he.amPM && (he.amPM.textContent = "PM",
                i(),
                oe())
            }
            te("KeyDown", e)
    ...
    function P(e) {
        if (1 === he.selectedDates.length && e.classList.contains("flatpickr-day")) {
            ...
            for (var l = he.days.childNodes[0].dateObj.getTime(), c = 0; c < 42; c++,
            l += he.utils.duration.DAY) {
                (function(o, l) {
                    var c = o < he.minRangeDate.getTime() || o > he.maxRangeDate.getTime()
                      , s = he.days.childNodes[l];
                    if (c)
                        return he.days.childNodes[l].classList.add("notAllowed"),
                    ...
                    e.classList.add(t < he.selectedDates[0] ? "startRange" : "endRange"),
    ...
    function H(e) {
        if (he.isMobile)
            ...
            void te("Open");
        he.isOpen || he._input.disabled || he.config.inline || (he.isOpen = !0,
        he.calendarContainer.classList.add("open"),
        J(),
        he._input.classList.add("active"),
        te("Open"))
    }
    function R(e) {
        return function(t) {
            ...
            he.selectedDates.length || "min" !== e || r(n),
            oe()),
            he.daysContainer && (K(),
    ...
    function W() {
        ...
        he.config.parseDate = a.parseDate,
        he.config.formatDate = a.formatDate,
        _extends(he.config, a),
        ...
        he.config.minDate = a.minDate,
        he.config.maxDate = a.maxDate;
    ...
    function J() {
        if (void 0 !== he.calendarContainer) {
            ...
            if (fe(he.calendarContainer, "arrowTop", !r),
            fe(he.calendarContainer, "arrowBottom", r),
            !he.config.inline) {
                var l = window.pageXOffset + a.left
                  , c = window.document.body.offsetWidth - a.right
                  , s = l + t > window.document.body.offsetWidth;
                fe(he.calendarContainer, "rightMost", s),
                he.config.static || (he.calendarContainer.style.top = o + "px",
                s ? (he.calendarContainer.style.left = "auto",
                he.calendarContainer.style.right = c + "px") : (he.calendarContainer.style.left = l + "px",
                he.calendarContainer.style.right = "auto"))
            }
        }
    }
    function K() {
        he.config.noCalendar || he.isMobile || (E(),
        re(),
        M())
    }
    function U(e) {
        if (e.preventDefault(),
        e.stopPropagation(),
        e.target.classList.contains("flatpickr-day") && !e.target.classList.contains("disabled") && !e.target.classList.contains("notAllowed")) {
            var t = he.latestSelectedDateObj = new Date(e.target.dateObj.getTime())
              , n = t.getMonth() !== he.currentMonth && "range" !== he.config.mode;
            if (he.selectedDateElem = e.target,
            "single" === he.config.mode)
                he.selectedDates = [t];
            else if ("multiple" === he.config.mode) {
                var a = ae(t);
                a ? he.selectedDates.splice(a, 1) : he.selectedDates.push(t)
            } else
                "range" === he.config.mode && (2 === he.selectedDates.length && he.clear(),
                he.selectedDates.push(t),
                0 !== ge(t, he.selectedDates[0], !0) && he.selectedDates.sort(function(e, t) {
                    return e.getTime() - t.getTime()
                }));
            if (i(),
            n) {
                var o = he.currentYear !== t.getFullYear();
                he.currentYear = t.getFullYear(),
                he.currentMonth = t.getMonth(),
                o && te("YearChange"),
                te("MonthChange")
            }
            if (M(),
            he.minDateHasTime && he.config.enableTime && 0 === ge(t, he.config.minDate) && r(he.config.minDate),
            oe(),
            he.config.enableTime && setTimeout(function() {
                return he.showTimeInput = !0
            }, 50),
            "range" === he.config.mode && (1 === he.selectedDates.length ? (P(e.target),
    ...
    function G(e, t, n) {
        if (!e)
            return he.clear(t);
        z(e, n),
        he.showTimeInput = he.selectedDates.length > 0,
        he.latestSelectedDateObj = he.selectedDates[0],
        he.redraw(),
        g(),
        r(),
        oe(t),
    ...
    function V() {
        function e(e) {
            for (var t = e.length; t--; )
                "string" == typeof e[t] || +e[t] ? e[t] = he.parseDate(e[t], null, !0) : e[t] && e[t].from && e[t].to && (e[t].from = he.parseDate(e[t].from),
        ...
        he.selectedDates = [],
        he.now = new Date,
        he.config.disable.length && (he.config.disable = e(he.config.disable)),
        ...
        he.currentYear = n.getFullYear(),
        he.currentMonth = n.getMonth(),
        he.selectedDates.length && (he.latestSelectedDateObj = he.selectedDates[0]),
        ...
        he.isMobile || Object.defineProperty(he, "showTimeInput", {
            ...
            set: function(e) {
                he._showTimeInput = e,
                he.calendarContainer && fe(he.calendarContainer, "showTimeInput", e),
                J()
            }
        })
    }
    function Z() {
        he.utils = {
            ...
            getDaysinMonth: function(e, t) {
                return e = void 0 === e ? he.currentMonth : e,
                t = void 0 === t ? he.currentYear : t,
                1 === e && (t % 4 == 0 && t % 100 != 0 || t % 400 == 0) ? 29 : he.l10n.daysInMonth[e]
            },
            monthToStr: function(e, t) {
                return t = void 0 === t ? he.config.shorthandCurrentMonth : t,
                he.l10n.months[(t ? "short" : "long") + "hand"][e]
            }
        }
    }
    function q() {
        ...
        he.revFormat.F = Flatpickr.prototype.revFormat.F.bind(he),
        he.revFormat.M = Flatpickr.prototype.revFormat.M.bind(he)
    }
    function Q() {
        if (he.input = he.config.wrap ? he.element.querySelector("[data-input]") : he.element,
        !he.input)
            return console.warn("Error: invalid input element specified", he.input);
        he.input._type = he.input.type,
        he.input.type = "text",
        he.input.classList.add("flatpickr-input"),
        he._input = he.input,
        he.config.altInput && (he.altInput = de(he.input.nodeName, he.input.className + " " + he.config.altInputClass),
        he._input = he.altInput,
        he.altInput.placeholder = he.input.placeholder,
        he.altInput.disabled = he.input.disabled,
        he.altInput.type = "text",
        he.input.type = "hidden",
        !he.config.static && he.input.parentNode && he.input.parentNode.insertBefore(he.altInput, he.input.nextSibling)),
        he.config.allowInput || he._input.setAttribute("readonly", "readonly"),
        he._positionElement = he.config.positionElement || he._input
    }
    function X() {
        var e = he.config.enableTime ? he.config.noCalendar ? "time" : "datetime-local" : "date";
        he.mobileInput = de("input", he.input.className + " flatpickr-mobile"),
        he.mobileInput.step = "any",
        he.mobileInput.tabIndex = 1,
        he.mobileInput.type = e,
        he.mobileInput.disabled = he.input.disabled,
        he.mobileInput.placeholder = he.input.placeholder,
        he.mobileFormatStr = "datetime-local" === e ? "Y-m-d\\TH:i:S" : "date" === e ? "Y-m-d" : "H:i:S",
    ...
    function te(e, t) {
        ...
        "Change" === e && (he.input.dispatchEvent(ne("change")),
        he.input.dispatchEvent(ne("input")))
    }
    function ne(e) {
        return he._supportsEvents ? new Event(e,{
            bubbles: !0
        }) : (he._[e + "Event"] = document.createEvent("Event"),
        he._[e + "Event"].initEvent(e, !0, !0),
        he._[e + "Event"])
    }
    function ae(e) {
        for (var t = 0; t < he.selectedDates.length; t++)
            if (0 === ge(he.selectedDates[t], e))
                return "" + t;
        return !1
    }
    function ie(e) {
    ...
    function re() {
        ...
        he.currentYearElement.value = he.currentYear,
        he._hidePrevMonthArrow = he.config.minDate && (he.currentYear === he.config.minDate.getFullYear() ? he.currentMonth <= he.config.minDate.getMonth() : he.currentYear < he.config.minDate.getFullYear()),
    ...
    function oe(e) {
        ...
        he.config.altInput && (he.altInput.value = he.selectedDates.map(function(e) {
    ...
    function ce(e) {
        ...
        if (e.target === he.currentMonthElement || t) {
            var n = le(e);
            t ? (O(he.currentYear + n),
            e.target.value = he.currentYear) : he.changeMonth(n, !0, !1)
        }
    }
    function se(e) {
        var t = he.prevMonthNav.contains(e.target)
          , n = he.nextMonthNav.contains(e.target);
        t || n ? T(t ? -1 : 1) : e.target === he.currentYearElement ? (e.preventDefault(),
    ...
    function pe(e) {
        ...
        if (void 0 !== n.value && 2 === n.value.length) {
            ...
            l < a ? (l = i + l + !c + (c && !he.amPM),
            s && h(null, -1, he.hourElement)) : l > i && (l = n === he.hourElement ? l - i - !he.amPM : a,
            s && h(null, 1, he.hourElement)),
            he.amPM && c && (1 === r ? l + o === 23 : Math.abs(l - o) > r) && (he.amPM.textContent = "PM" === he.amPM.textContent ? "AM" : "PM"),
            n.value = he.pad(l)
        }
    }
    var he = this;
    ...
    he.toggle = ee,
    function() {
        he.element = he.input = e,
        he.instanceConfig = t || {},
        he.parseDate = Flatpickr.prototype.parseDate.bind(he),
        he.formatDate = Flatpickr.prototype.formatDate.bind(he),
        q(),
        W(),
        B(),
        Q(),
        ...
        Z(),
        he.isOpen = !1,
        he.isMobile = !he.config.disableMobile && !he.config.inline && "single" === he.config.mode && !he.config.disable.length && !he.config.enable.length && !he.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
        he.isMobile || v(),
        d(),
        (he.selectedDates.length || he.config.noCalendar) && (he.config.enableTime && r(he.config.noCalendar ? he.latestSelectedDateObj || he.config.minDate : null),
        oe()),
        he.config.weekNumbers && (he.calendarContainer.style.width = he.daysContainer.offsetWidth + he.weekWrapper.offsetWidth + "px"),
        he.showTimeInput = he.selectedDates.length > 0 || he.config.noCalendar,
        he.isMobile || J(),
        te("Ready")
    }(),
    he
...
function _flatpickr(e, t) {
    for (var n = Array.prototype.slice.call(e), a = [], i = 0; i < n.length; i++)
        try {
            n[i]._flatpickr && (n[i]._flatpickr.destroy(),
            n[i]._flatpickr = null),
...
Flatpickr.prototype = {
    ...
    parseDate: function(e, t, n) {
        ...
        return e instanceof Date ? (!0 === n && e.setHours(0, 0, 0, 0),
